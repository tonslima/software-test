...
import br.com.marvin.api.domain.ReconciliationResult
import br.com.marvin.api.domain.RunStatus
import br.com.marvin.api.infrastructure.csv.ReconciliationCsvParser
import br.com.marvin.api.infrastructure.messaging.AlertEventPublisher
...
class ProcessReconciliationUseCase(
    ...
    private val fileStorage: ReconciliationFileStorage,
    private val csvParser: ReconciliationCsvParser,
